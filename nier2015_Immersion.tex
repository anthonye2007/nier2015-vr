...
due to insufficient ability to navigate and understand the code under review~\cite{bacchelli:ModernCodeReviewChallenges}.  Other challenges, such as remote pairing, still persist.
...
Researchers have attempted to improve programming environments by better understanding the human capacity for attention, cognition, and memory.
For example, \emph{spatial memory}, definition, has .

...
Consider the comet scenario from before where a programmer has implemented a repositioning flight path for the lander.

A reviewer puts on the Rift and enters \textsc{Immersion} to ensure this solution will actually work.
She notes an edge case which might cause a collision and suggests gently crashing the companion orbiter into the probe.
...
As she walks over to the section she sees that it is the collision detection section.

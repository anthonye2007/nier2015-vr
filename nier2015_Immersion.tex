...
Existing applications include NASA who is using VR to control a robotic arm resulting in higher efficiency [1]. Educational experience Titans of Space [2] allows students to experience our solar system in a way that makes them feel like they are truly right next to the sun.

VR has opened the door for software engineers to create systems that increase efficiency and enable previously impossible experiences. An area of future research is how to create tools for the software engineers creating these VR systems.  Which existing tools will still be helpful?  What problems do VR software engineers face that have no tool support?

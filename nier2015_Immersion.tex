...
We then describe a scenario which describes a future programming environment which fully integrates VR.  We then describe several systems we have prototyped to begin realizing this scenario and how the systems can be used in several applications related to software engineering.  Finally, Ww provide a brief discussion of some open research questions and discuss some of the challenges of using VR in software engineering with existing technologies.

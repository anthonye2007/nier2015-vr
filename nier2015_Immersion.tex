...
Still, the fundamental design behind a programming environment has not significantly changed in decades.


For example, consider the programming environment reduced to its fundamental form: a main window for viewing content with a set of navigational links (tabs, tree views, and search results) to allow transitions between content.  More advanced forms allow multiple fragments or windows software to be displayed at once.
...
Human capacity for attention and memory ground our designs; but limited design choices and increasing 

...
\todo{EkstEta VR|: Weave in virtual space earlier, talk about navigation in VR triggering place cells too.}
...
%In nature, information comes with a physical address (and often a temporal one), and one can navigate to and from the address. Those raspberry patches we found last year are over the hill and through the woods Ñ and they are still over the hill and through the woods.

...
\begin{figure}[ht!]
\centering
\includegraphics[width=70mm]{figures/dk2}
\caption{Oculus Rift Development Kit 2 \label{overflow}}
\end{figure}
\begin{figure}[ht!]
\centering
\includegraphics[width=70mm]{figures/LeapAndKeyboard}
\caption{Leap Motion Controller \label{overflow}}
\end{figure}

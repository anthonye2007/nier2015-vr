...
The Rift requires users to measure the distance between their pupils for more accurate stereoscopic rendering, but current utilities are either time consuming or hard to use properly.
...
%\subsubsubsection{Inter-pupillary distance}
...
%\subsubsubsection{Lenses and Field of View}

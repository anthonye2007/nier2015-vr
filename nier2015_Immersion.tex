...
First, we show how an immersive code review environment could enable software engineers to more easily analyze and navigate information.
...
Finally, we show how an immersive environment could be used to provide faster feedback when affecting 3D objects.
